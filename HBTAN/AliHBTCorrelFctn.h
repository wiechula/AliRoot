...
class AliHBTAvSeparVsTwoKStarCorrelFctn: public AliHBTOnePairFctn2D, public AliHBTCorrelFunction
{
//   Correlation Function of 2*KStar
 public:
   AliHBTAvSeparVsTwoKStarCorrelFctn(Int_t nXbins = 10, Double_t maxXval = 0.05, Double_t minXval = 0.,
                           Int_t nYbins = 20, Double_t maxYval = 20, Double_t minYval = 0.0);
   virtual ~AliHBTAvSeparVsTwoKStarCorrelFctn(){};
   TH1* GetResult();
 protected:
   void GetValues(AliHBTPair* pair, Double_t& x, Double_t& y) const
    {
 ...
 private:  
    ClassDef(AliHBTAvSeparVsTwoKStarCorrelFctn,1)
};


/*************************************************************************************/

class AliHBTITSSepVsQInvCorrelFctn: public AliHBTOnePairFctn3D, public AliHBTCorrelFunction
{
//   Correlation Function of 2*KStar
 public:
   AliHBTITSSepVsQInvCorrelFctn(Int_t layer = 0 ,Int_t nXbins = 10, Double_t maxXval = 0.05, Double_t minXval = 0.,
                                Int_t nYbins = 10, Double_t maxYval = 1., Double_t minYval = 0.0,
                                Int_t nZbins = 10, Double_t maxZval = 2., Double_t minZval = 0.0);
   virtual ~AliHBTITSSepVsQInvCorrelFctn(){};
   TH1* GetResult();
 protected:
   void GetValues(AliHBTPair* pair, Double_t& x, Double_t& y, Double_t& z) const;
...
//   Correlation Function of 2*KStar
 public:
   AliHBTITSSepVsTwoKStarSideCorrelFctn(Int_t layer = 0 ,Int_t nXbins = 10, Double_t maxXval = 0.05, Double_t minXval = 0.,
                                Int_t nYbins = 10, Double_t maxYval = 1., Double_t minYval = 0.0,
                                Int_t nZbins = 10, Double_t maxZval = 2., Double_t minZval = 0.0);
   virtual ~AliHBTITSSepVsTwoKStarSideCorrelFctn(){};
   TH1* GetResult();
 protected:
   void GetValues(AliHBTPair* pair, Double_t& x, Double_t& y, Double_t& z) const;
 ...
 private:  
    ClassDef(AliHBTITSSepVsTwoKStarSideCorrelFctn,1)
};
