...
#define HLTCA_GPU_SLICE_DATA_MEMORY 10 * 1024 * 1024		//Amount of Slice Data Memory to reserve per Slice on GPU
#define HLTCA_GPU_GLOBAL_MEMORY 30 * 1024 * 1024		//Amount of global temporary Memory to reserve per Slice on GPU
#define HLTCA_GPU_TRACKS_MEMORY 6 * 1024 * 1024			//Amount of Memory to reserve for Final Tracks per Slice on Host as Page Locked Memory
