...
class TFluka : public TVirtualMC {
 ...
 public:
  ...
  virtual Int_t VolId2Mate(Int_t id) const
    {printf("VolId2Mate not yet implemented !\n"); return -1;}
  ...
  virtual void     SetCut(const char* cutName, Double_t cutValue)
    {printf("SetCut not yet implemented !\n");}
  virtual void     SetProcess(const char* flagName, Int_t flagValue)
    {printf("SetProcess not yet implemented !\n");}
  ...
  virtual Double_t TrackTime() const
    {printf("TrackTime not yet implemented !\n"); return -1.;}
  ...
  virtual Double_t TrackMass() const
    {printf("TrackMass not yet implemented !\n"); return -1.;}
  ...
  virtual TMCProcess ProdProcess(Int_t isec) const
    {printf("StepProcesses not yet implemented !\n"); return kPNoProcess;} 
