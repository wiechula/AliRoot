...
ClassImp(AliTRDrawStreamOnline)
...
Bool_t AliTRDrawStreamOnline::ReadEvent(TTree *trackletTree)
{
...
Bool_t AliTRDrawStreamOnline::NextDDL()
{
...
Int_t AliTRDrawStreamOnline::NextChamber(AliTRDdigitsManager *digMgr, UInt_t ** /* trackletContainer */, UShort_t ** /* errorContainer */)
{
...
Int_t AliTRDrawStreamOnline::ReadSmHeader()
{
...
Int_t AliTRDrawStreamOnline::ReadStackIndexHeader(Int_t stack)
{
...
Int_t AliTRDrawStreamOnline::ReadLinkData()
{
  ...
  if (det > -1 && det < 540) {
    ...
    if (fDigitsParam) {
      fDigitsParam->SetPretiggerPhase(det, fCurrPtrgPhase);
      fDigitsParam->SetNTimeBins(fCurrNtimebins);
      fDigitsParam->SetADCbaseline(10);
    }
...
Int_t AliTRDrawStreamOnline::ReadTracklets()
{
...
Int_t AliTRDrawStreamOnline::ReadTPData(Int_t mode)
{
...
Int_t AliTRDrawStreamOnline::ReadZSData()
{
...
Int_t AliTRDrawStreamOnline::ReadNonZSData()
{
