////////////////////////////////////////////////////////////////////////////////
///                                                                          ///
/// AliFemtoEventReaderESDKineTPCOnly - the reader class for the Alice ESD   ///
/// Reads in ESD information and converts it into internal AliFemtoEvent     ///
/// Reads in TPC only momentum                                               ///
...
#include "AliFemtoEventReaderESDKineTPCOnly.h"
...
ClassImp(AliFemtoEventReaderESDKineTPCOnly)
...
AliFemtoEventReaderESDKineTPCOnly::AliFemtoEventReaderESDKineTPCOnly():
  fInputFile(" "),
  fFileName(" "),
  fNumberofEvent(0),
  fCurEvent(0),
...
AliFemtoEventReaderESDKineTPCOnly::AliFemtoEventReaderESDKineTPCOnly(const AliFemtoEventReaderESDKineTPCOnly &aReader) :
  fInputFile(" "),
  fFileName(" "),
  fNumberofEvent(0),
  fCurEvent(0),
...
//__________________
AliFemtoEventReaderESDKineTPCOnly& AliFemtoEventReaderESDKineTPCOnly::operator=(const AliFemtoEventReaderESDKineTPCOnly& aReader)
{
  // assignment operator
  if (this == &aReader)
    return *this;
...
//__________________
AliFemtoString AliFemtoEventReaderESDKineTPCOnly::Report()
{
  // create reader report
  AliFemtoString temp = "\n This is the AliFemtoEventReaderESDKineTPCOnly\n";
  return temp;
}

//__________________
void AliFemtoEventReaderESDKineTPCOnly::SetInputFile(const char* inputFile)
{
...
AliFemtoEvent* AliFemtoEventReaderESDKineTPCOnly::ReturnHbtEvent()
{
...
//	  fTree->SetBranchStatus("fTracks.fCalibContainer",0);
	...
	{
	  cout<<"no more events in input "<<hbtEvent<<endl;
	  fReaderStatus=1;
	  return hbtEvent; 
	}
    }		
...
// 	tGoodMomentum=esdtrack->GetPxPyPz(pxyz);//reading noconstarined momentum
	...
	if (param->PropagateToDCA(fEvent->GetPrimaryVertex(), (fEvent->GetMagneticField()), 10000))
// 	if (param->PropagateTo(0.0, (fEvent->GetMagneticField())*kilogauss))
// 	  {
	    param->GetPxPyPz(pxyz);//reading noconstarined momentum
// 	  }
 	else {
 	  cout << "Did not propagate track !!!" << endl;
 	}
	delete param;
      }
      else {
