...
COMMAND @echo -e '\t$$(LD) $$(LDFLAGS) -o ''$$''@ ''$$''< ${CMAKE_LIBRARY_OUTPUT_DIRECTORY}/lib${DALIB}.a ${CMAKE_LIBRARY_OUTPUT_DIRECTORY}/${EXTRAROOTLIB} $$(ROOT_LIBDIR)/libRoot.a $$(ROOT_LIBDIR)/liblzma.a $$(ROOT_LIBDIR)/libfreetype.a $$(ROOT_LIBDIR)/libpcre.a ${SYSLIBS} $$(DAQDALIB) ${AMOREDALIBS} ${MONITORLIBS}' >> ${DAMAKEFILE}
COMMAND @echo "" >> ${DAMAKEFILE}
...
COMMAND g++ ${LDFLAGS} ${DAOBJ} ${CMAKE_LIBRARY_OUTPUT_DIRECTORY}/lib${DALIB}.a ${EXTRAROOTLIB} ${ROOT_LIBDIR)/libRoot.a ${ROOT_LIBDIR)/liblzma.a ${ROOT_LIBDIR)/libfreetype.a ${ROOT_LIBDIR)/libpcre.a  ${SYSLIBS} ${DAQDALIB} ${AMOREDALIBS} ${MONITORLIBS} -o ${DAEXE}
WORKING_DIRECTORY ${CMAKE_LIBRARY_OUTPUT_DIRECTORY}
)
