...
//_______________
Bool_t AliAODCaloTrigger::Add(Int_t col, Int_t row, Float_t amp, Float_t time, Int_t trgtimes[], Int_t ntrgtimes, Int_t trgtimesum, Int_t trgbits)
{
  fCurrent++;
  ...
  fL1TimeSum[fCurrent] = trgtimesum;	
...
//_______________
Bool_t AliAODCaloTrigger::Add(Int_t col, Int_t row, Float_t amp, Float_t time, Int_t trgtimes[], Int_t ntrgtimes, Int_t trgtimesum, Int_t subra, Int_t trgbits)
{
  Add(col, row, amp, time, trgtimes, ntrgtimes, trgtimesum, trgbits);
